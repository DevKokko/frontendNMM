                ...
                <Col xs="12" sm="7" id={classes.left_panel} className="d-flex p-0"> 
                    <div className={classes.panel_bg_gradient}>
                        <Card className="h-100 border-0" style={{backgroundColor: "inherit", paddingTop: "8%"}}>
                            <CardBody id={classes.title} className="pb-0 pt-0 pr-0" style={{flex: this.props.isAuthed?"0 1 auto":"1 1 auto"}}>
                            ...
                            
                            {
                                this.props.isAuthed && 
                                    <CardBody style={{height: "200px"}}>
                                        <GroupChat username={this.props.username} userId={this.props.userId}/>
                                    </CardBody>
                            }

        ...
        API.signIn(axios, formData).then(res => {
            ...
            if (!res.success)
            {
                ...
                if (res.isBanned) {
                    this.setState(
                        produce( draft => {
                            draft.alert.message = "Account has been banned...";
            ...
            {
                this.props.onSignInSuccess(res.data.token, res.data.userId, res.data.username, res.data.isAdmin);
...
const mapDispatchToProps = dispatch => {
    return {
        onSignInSuccess: (token, userId, username, isAdmin) => dispatch(actions.authSuccess(token, userId, username, isAdmin))
    }
}
